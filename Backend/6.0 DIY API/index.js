...
app.get("/random", (req, res) => {
  var numOfJokes = jokes.length;
  var randomJokeIndex = Math.floor(Math.random() * numOfJokes);
...
app.get("/filter", (req, res) => {
  var filteredJokes = jokes.filter(
    (joke) => joke.jokeType.toLowerCase() === req.query.type.toLowerCase()
  );
...
app.put("/jokes/:id", (req, res) => {
  try {
    ...
    var id = parseInt(req.params.id);
    var index = jokes.findIndex((e) => e.id === id);
    var joke = jokes.find((e) => e.id === id);
    jokes[index] = {
      id: id,
